...
export default function Error({ retry }: { error: Error & { digest?: string }; retry: () => void }) {
  return (
    <NoticeScreen
      ...
      message="Data dashboard tidak bisa diambil dari database. Periksa koneksi, lalu coba lagi."
      hint="Kalau ini terus terjadi, buka /api/health untuk melihat komponen mana yang bermasalah."
    >
